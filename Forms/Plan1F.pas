...
uses
  ...
  Menus, ActnPopup, PlatformDefaultStyleActnCtrls, StdCtrls, DBCtrls,
...
type
  TPlan1 = class(TForm)
    ...
    Q_Mast: TIBQuery;
    Q_BrowseP: TIBQuery;
    Q_BrowseNAIM: TIBStringField;
    Q_BrowseTEL: TIBStringField;
    Q_BrowseNAIMM: TIBStringField;
    Q_BrowseTM_S: TIBStringField;
    Q_BrowseTM_E: TIBStringField;
    Q_BrowseCODE_PR: TIntegerField;
    Q_BrowseTYPE_: TSmallintField;
    Q_BrowsePRIZ: TSmallintField;
    Q_BrowseID_NAKL: TIntegerField;
    Q_BrowseOT: TDateField;
    Q_BrowseID: TIntegerField;
    Q_BrowseCODE_MAST: TIntegerField;
    Q_BrowseCOMMENT: TIBStringField;
    Q_BrowsePNAIM: TIBStringField;
    Q_BrowsePTEL: TIBStringField;
    Q_BrowsePNAIMM: TIBStringField;
    Q_BrowsePTM_S: TIBStringField;
    Q_BrowsePTM_E: TIBStringField;
    Q_BrowsePCODE_PR: TIntegerField;
    Q_BrowsePTYPE_: TSmallintField;
    Q_BrowsePPRIZ: TSmallintField;
    Q_BrowsePID_NAKL: TIntegerField;
    Q_BrowsePOT: TDateField;
    Q_BrowsePID: TIntegerField;
    Q_BrowsePCODE_MAST: TIntegerField;
    Q_BrowsePCOMMENT: TIBStringField;
    Q_DrCODE_PR: TIntegerField;
    Q_DrNAIM: TIBStringField;
    Q_DrTEL: TIBStringField;
    Q_DrBIRTH_DATE: TDateField;
    Q_MastNAIM: TIBStringField;
...
procedure TPlan1.ComboBox1Change(Sender: TObject);
begin
  naim_p:=Combobox1.Text;
  A_WinCr.Execute;
end;

procedure TPlan1.ComboBox1DropDown(Sender: TObject);
begin
...
procedure TPlan1.CreateWindowHandle(const Params: TCreateParams);
  var Comp:TPlan1;
begin
  inherited;
  Comp:=TPlan1(Application.Components[Application.ComponentCount-1]);
  Comp.Visible:=false;
end;


procedure TPlan1.EditPlan(ApptStartDate, ApptEndDate:
...
procedure TPlan1.FormClose(Sender: TObject; var Action: TCloseAction);
begin
 if  DataMain.IBT.InTransaction then  DataMain.IBT.Commit;
  Action := caFree;
end;

procedure TPlan1.FormCreate(Sender: TObject);
begin
...
procedure TPlan1.FormDestroy(Sender: TObject);
begin
if DataMain.IBT.InTransaction then  DataMain.IBT.Commit;
end;

procedure TPlan1.A_InsExecute(Sender: TObject);
begin
  try
...
procedure TPlan1.A_EditExecute(Sender: TObject);
var cap1 : string;
...
procedure TPlan1.A_DelExecute(Sender: TObject);
var id : integer;
  Cap1 : string;
begin
...
procedure TPlan1.A_AddExecute(Sender: TObject);
var cap2 : string;
i : integer;
...
procedure TPlan1.A_ClearExecute(Sender: TObject);
var i, k : integer;
begin
  with TFS do
  begin
...
procedure TPlan1.A_WinCRExecute(Sender: TObject);
var i, k : integer;
begin

//  tfd.ScheduleManager := datamain.TFS;
...
procedure TPlan1.A_W_BExecute(Sender: TObject);
begin
  dat := dat -7;
  A_WinCr.Execute;
end;

procedure TPlan1.A_W_FExecute(Sender: TObject);
begin
  dat := dat + 7;
  A_WinCr.Execute;
end;

procedure TPlan1.TFDDblClick(Sender: TObject);
begin
  A_Edit.Execute;
end;
