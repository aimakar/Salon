...
uses
  ...
  Menus, ActnPopup, PlatformDefaultStyleActnCtrls, StdCtrls, IBCustomDataSet,
  IBQuery;
...
procedure TPlan2.FormActivate(Sender: TObject);
begin
...
procedure TPlan2.FormDestroy(Sender: TObject);
begin
if DataMain.IBT.InTransaction then  DataMain.IBT.Commit;
end;
