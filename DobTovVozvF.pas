  ...
  Application.CreateForm(TAddKolIzl, AddKolIzl);
     case Key of
          VK_INSERT, VK_RETURN : begin
                    ...
                    AddKolIzl.Label2.Caption := 'Остаток '+ Trim(DataMain.Tovar.FieldByName('Ost1').AsString)+
                    ' (в упаковке по '+Trim(DataMain.Tovar.FieldByName('Up').AsString)+' штук.)';
